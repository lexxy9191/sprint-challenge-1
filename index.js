...
console.log('test 1:', artists[0].name);

//(2) Bio of the third artist (2nd index) in the array 
console.log('test 2:', artists[2].bio);
...
function removeArtist(array, index) {
  ...
  let smallArray = [...array];
  smallArray.splice(index, 1); 
  return smallArray
   }
...
console.log("task 6", addArtist(artists, "Alexia Turner", "1991-2022", "web Design", "American","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Est lorem ipsum dolor sit amet consectetur."))
...
let info = array.find(element => element.name === name );
return info.bio;
}
